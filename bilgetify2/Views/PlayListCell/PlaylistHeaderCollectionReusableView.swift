...
import SDWebImage
import UIKit
protocol PlaylistHeaderCollectionReusableViewDelegate: AnyObject { // ilgili albümün ya da playlist in header ını çizen kısım. orada da playlist in kime ait olduğu, resim, ikon vs bulunuyor
